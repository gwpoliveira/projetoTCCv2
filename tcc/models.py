...
class Tcc(models.Model):
    ...
    curso = models.ForeignKey(Curso,verbose_name='Curso', on_delete=models.CASCADE, blank=False, null=True)
    ...
    def __str__(self):
        return f'{self.periodo} {self.disciplina} {self.nomeAluno} {self.aluno.tituloTCC} {self.membro01} {self.membro02} {self.membro03}'